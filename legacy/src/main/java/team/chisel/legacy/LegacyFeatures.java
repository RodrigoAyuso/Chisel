...
public class LegacyFeatures {
    ...
    public static final Map<String, BlockEntry<BlockCarvable>> GLASS = _FACTORY.newType(Material.GLASS, "glass")
            ...
            .equivalentTo(Tags.Blocks.GLASS_COLORLESS)
            .applyTag(Tags.Blocks.GLASS)
...
//            .next("chinese")
    ...
    public static final Map<String, BlockEntry<BlockCarvablePane>> GLASSPANE = _FACTORY.newType(Material.GLASS, "glasspane", BlockCarvablePane::new)
            ...
            .equivalentTo(Tags.Blocks.GLASS_PANES_COLORLESS)
            .applyTag(Tags.Blocks.GLASS_PANES)
            .initialProperties(() -> Blocks.GLASS)
            .variation("terrain_glassbubble").localizedName("Bubble")
            .model(ModelTemplates.paneBlockCTM("block/glass/edge"))
            .itemModel(ItemModelTemplates.pane())
//            .next("chinese")
...
//                .itemModel((ctx, prov) -> prov.withExistingParent("item/" + prov.name(ctx::getEntry), new ResourceLocation("item/generated")).texture("layer0", "block/" + prov.name(ctx::getEntry).replaceFirst("pane", "")))
    ...
    public static Map<DyeColor, Map<String, BlockEntry<BlockCarvable>>> GLASS_STAINED = Arrays.stream(DyeColor.values())
            .collect(Collectors.toMap(Function.identity(), color -> _FACTORY.newType(Material.GLASS, "glass_stained/" + color.getSerializedName())
                    ...
                    .equivalentTo(BlockTags.create(new ResourceLocation("forge", "glass/" + color.getSerializedName())))
                    .applyTag(Tags.Blocks.STAINED_GLASS)
                    .applyTag(Tags.Blocks.GLASS_TINTED)
                    .variation("panel")
                    .next("framed")
                    ...
                    .next("streaks")
                    .next("rough")
                    .model(ModelTemplates.cube("block/glass_stained/" + color.getSerializedName() + "/rough"))
                    .next("brick")
                    .model(ModelTemplates.cube("block/glass_stained/" + color.getSerializedName() + "/brick"))
                    .build(b -> b.sound(SoundType.GLASS).explosionResistance(0.3F))
            ));
    ...
    public static Map<DyeColor, Map<String, BlockEntry<BlockCarvablePane>>> GLASSPANE_STAINED = Arrays.stream(DyeColor.values())
            .collect(Collectors.toMap(Function.identity(), color -> _FACTORY.newType(Material.GLASS, "glasspane_stained/" + color.getSerializedName(), BlockCarvablePane::new)
                    .addBlock(new ResourceLocation(color.getSerializedName() + "_stained_glass_pane"))
                    ...
                    .applyTag(Tags.Blocks.STAINED_GLASS_PANES)
                    .variation("panel")
                    .model(ModelTemplates.paneBlock("minecraft:block/" + color.getSerializedName() + "_stained_glass_pane_top"))
                    .itemModel(ItemModelTemplates.pane())
                    .next("framed")
                    .model(ModelTemplates.paneBlockCTM("minecraft:block/" + color.getSerializedName() + "_stained_glass_pane_top", "block/glass_stained/" + color.getSerializedName() + "/framed", "block/glass_stained/" + color.getSerializedName() + "/framed", color.getSerializedName()))
                    .itemModel(ItemModelTemplates.pane())
                    .next("framed_fancy").localizedName("Fancy-Framed")
                    .model(ModelTemplates.paneBlockCTM("minecraft:block/" + color.getSerializedName() + "_stained_glass_pane_top", "block/glass_stained/" + color.getSerializedName() + "/framed", "block/glass_stained/" + color.getSerializedName() + "/framed_fancy", color.getSerializedName()))
                    .itemModel((prov, item) -> prov.withExistingParent("item/" + prov.name(() -> item), new ResourceLocation("item/generated")).texture("layer0", "block/glass_stained/" + color.getSerializedName() + "/framed"))
                    .next("streaks")
                    .model(ModelTemplates.paneBlock("minecraft:block/" + color.getSerializedName() + "_stained_glass_pane_top"))
                    .itemModel(ItemModelTemplates.pane())
                    .next("rough")
    ...
    public static final Map<String, BlockEntry<BlockCarvablePane>> IRONPANE = _FACTORY.newType(Material.GLASS, "ironpane", BlockCarvablePane::new)
            ...
            .itemModel(ItemModelTemplates.texture())
